...
public class BoxTableExtractor 
{
    ...
    public ArrayList<Table> extract(File pdfFile, String id, String metid) 
    {
        ...
        if (wordsByPage != null && wordsByPage.size()!=0 ) {    //in order to keep the fast speed for large repositories, we do not process PDF files with 150+ pages
            ...
            if (pageNum > 150) {
                System.out.printf("pdf grande d+");
                return null;
            }
            /*
            ...
            if (unknownCodedDoc) {
                System.out.printf("null unknownCodedDoc");
                    return null;
            }
            boolean isHTMLCode = true;
            isHTMLCode = judgeHTMLCode(wordsByPage);
            if (isHTMLCode) {
                System.out.printf("null isHTMLCode");
                    return null;
            }
            ...
            for (ArrayList<TextPiece> linesOfAPage : linesByPage) {
                ...
                System.out.println("\n :i " + i);
                System.out.println("\n :wordsOfAPage " + wordsOfAPage);
                System.out.println("\n :linesOfAPage " + linesOfAPage);
                System.out.println("\n :linesByPage " + linesByPage);
            ...
            else { System.out.printf("null no tables"); return null; } // no tables
        }//end for
        System.out.printf("null end for");
        return null;
    }// extract()
